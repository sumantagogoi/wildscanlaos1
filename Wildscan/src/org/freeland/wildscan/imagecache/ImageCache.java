...
public class ImageCache {
    ...
    public void setEnableDiskCache(boolean enable) {
    	mCacheParams.diskCacheEnabled = enable;
    }
     ...
     */
    public void addBitmapToCache(String data, Bitmap value, boolean useDiskCache) {
        if (data == null || value == null || value.getConfig()==null) {
            return;
        }
