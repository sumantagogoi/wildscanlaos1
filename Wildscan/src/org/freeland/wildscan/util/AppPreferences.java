...
public class AppPreferences {
    ...
    public static String getSelectedRegions(Context context) {
        String regions = "2";
        if (isAfricaRegion(context)) regions = regions + "," + AppConstants.REGION_AFRICA_ID;
    ...
    public static void setRegions(Context context, boolean america, boolean asia, boolean africa) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor ed = sp.edit();
     ...
     ****************************************************/
    public static void setRegionStats(Context context, String globalContacts, String globalSpecies, String asiaContacts, String asiaSpecies
            , String americaContacts, String americaSpecies,
                                      String africaContacts, String africaSpecies) {
        ...
        ed.putString(AppConstants.AMERICA_CONTACTS, americaContacts);
        ed.putString(AppConstants.AMERICA_SPECIES, americaSpecies);
        ed.putString(AppConstants.AFRICA_CONTACTS, africaContacts);
        ed.putString(AppConstants.AFRICA_SPECIES, africaSpecies);
        ed.commit();
    }
