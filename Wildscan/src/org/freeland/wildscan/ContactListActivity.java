...
public class ContactListActivity extends Activity
    ...
    public static String KEY_RESULT_CONTACT_ID = "org.freeland.wildscan.ContactList.ContactId";
    public static String KEY_RESULT_CONTACT_NAME = "org.freeland.wildscan.ContactList.ContactName";
    public static String KEY_RESULT_CONTACT_EMAIL = "org.freeland.wildscan.ContactList.ContactEmail";
    public static String KEY_RESULT_CONTACT_ID_LIST = "org.freeland.wildscan.ContactList.ContactIdList";

    public static String KEY_REQUEST_RESULT = "org.freeland.wildscan.ContactList.RequestResult";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] columns_id = {Contacts._ID, Contacts._S_REGION, Contacts._AVATAR, Contacts._WEBSITE, Contacts._DETAILS, Contacts._FAV};
        String where = null;
        Log.e("TAG", where + " ");
        if (null == where) {
            where = "region = 2 ";
        ...
        String orderBy = Contacts._COUNTRY + " ASC";
...
//		mDisplayAreaLayout.addView(mListView, params);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Cursor c = getContentResolver().query(uri, columns, selection, null, null);
        c.moveToFirst();
...
//		String orderBy = WildscanDataManager.Contacts._NAME + " ASC";
        ...
        if (mShowFavs)
            ...
            if (AppPreferences.isAfricaRegion(ContactListActivity.this))
                selection = selection + " OR region = 1";
            if (AppPreferences.isAmericanRegion(ContactListActivity.this))
