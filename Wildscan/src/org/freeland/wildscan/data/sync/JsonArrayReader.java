...
import org.freeland.wildscan.App;
...
import org.freeland.wildscan.models.RegionSpeciesImages;
...
//				+ Species.TABLE_NAME + " WHERE " + SELECT_FORMAT + ")";
    ...
    public JsonArrayReader(Context context, String table) throws ClientProtocolException, IOException {
        this(context, table, context.getSharedPreferences(PrefsFragment.PREFS_FILENAME, 0).getLong(PrefsFragment.PREFS_KEY_LAST_SUCCESSFUL_SYNC, 0L));
    }

    public JsonArrayReader(Context context, String table, long lastSync) throws ClientProtocolException, IOException {
...
//            httpRequest.setEntity(new UrlEncodedFormEntity(requestParams));
            String param = "&t=" + AppConstants.API_SECRET_KEY + "&later_than=" +
...
//            httpRequest.setEntity(new UrlEncodedFormEntity(requestParams));
          ...
          /*  List<NameValuePair> requestParams = new ArrayList<NameValuePair>(1);
            ...
            String param = "r=get-submit-reports"/*&region=" + AppPreferences.getSelectedRegions(context)*/
