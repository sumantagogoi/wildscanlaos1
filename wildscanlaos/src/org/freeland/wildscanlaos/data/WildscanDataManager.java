...
//import org.freeland.wildscanapp.SyncProgressDialog;
...
import org.freeland.wildscanlaos.data.sync.WildscanSyncAdapter;
...
public class WildscanDataManager {
    ...
    public static final String REMOTE_BASE = "https://wildscan.org/laos/api/";
    ...
    //public static final long APK_MAIN_EXPANSION_FILE_SIZE = 29358292L;

    public static final int APK_MAIN_EXPANSION_FILE_VERSION = 100;
    ...
    private final static String[] INFO_SECTION_KEYS = {
            ...
            StaticContent._CREDITS, StaticContent._CONTRIBUTOR, StaticContent._HELP
    };
...
//	private static final String LOG_TAG = WildscanDataManager.class.getSimpleName();
    ...
    private Account getSyncAccount() {
        ...
        Account account = new Account("SyncAccount", "org.freeland.wildscanlaos.data.sync");
    ...
    public void requestSync(SyncProgressListener caller, boolean eventsOnly, boolean firstTime, ProgressDialog dialog) {
...
//    			mSpeciesAutocompleteList.add(c.getString(col_idx_sc_name));
    ...
    private void setupContactsList() {
		...
		//		Contacts._COUNTRY};
    	String[] columns = { Contacts._ID, Contacts._NAME, Contacts._COUNTRY };
        ...
        //String selection = Util.addLangToSelection(sDataManager.mAppContext, null, ContactsTranslations._S_LANGUAGE);
        //selection = Util.addRegionSelection(sDataManager.mAppContext, selection);
        //Cursor c = mAppContext.getContentResolver().query(queryUri, columns, selection, null, null);
        Cursor c = mAppContext.getContentResolver().query(queryUri, columns, null, null, null);
        ...
        if (c.moveToFirst()) {
            ...
            int col_idx_id = c.getColumnIndex(Contacts._ID), col_idx_name = c.getColumnIndex(Contacts._NAME), col_idx_country = c.getColumnIndex(Contacts._COUNTRY);
            do {
                String name = c.getString(col_idx_name), country = c.getString(col_idx_country);
                Integer id = c.getInt(col_idx_id);
                if (name != null) {
                ...
                if (country != null) {
                    mContactsAutocompleteList.add(new Pair<String, Integer>(country, id));
...
//				setupAvailableLanguages();
    ...
    public class WildscanSQLiteOpenHelper extends SQLiteOpenHelper {
        private static final String DATABASE_NAME = "wildscanapp";
