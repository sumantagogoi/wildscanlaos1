...
import org.freeland.wildscanlaos.util.Dialogs;
...
public class WildscanMainActivity extends Activity implements SyncProgressListener {
    ...
    */
    ...
    public void showSyncProgress() {
        ...
        mSyncProgress.setTitle("Sync Wildscan Database");
        mSyncProgress.setCancelable(false);
        mSyncProgress.show();
        mDataManager.requestSync(this, false, false, mSyncProgress);
        //mDataManager.requestSync(this, false, true);
    }
...
//				ver += "d";
    ...
    public void onClickInfoBtn(View v) {
        ...
        if (section != null) {
            ...
            mInfoDialog.findViewById(R.id.dialogInfoWebContainter).setVisibility(View.VISIBLE);
