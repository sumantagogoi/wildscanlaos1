...
public static final String REMOTE_SERVER_URL = "https://wildscan.org/laos/api/";
    public static final String REMOTE_BASE_IMAGE_URL = "https://wildscan" +
            ".org/laos/wildscan-uploads/";
    ...
    public static final String REGION_GLOBAL_ID = "1";
    //public static final String REGION_SOUTH_EAST_ASIA_ID = "2";
    //public static final String REGION_AFRICA_ID = "3";
    //public static final String REGION_SOUTH_AMERICA_ID = "4";


    public static final String REGION_GLOBAL_CODE = "laos";
    //public static final String REGION_SOUTH_EAST_ASIA_CODE = "se_asia";
    //public static final String REGION_AFRICA_CODE = "w_africa";
