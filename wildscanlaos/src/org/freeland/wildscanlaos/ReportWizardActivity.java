...
import org.freeland.wildscanlaos.Report.RecipientInfo;
...
//	static final String[] CONDITION_NAMES = { "alive", "dead", "mixed" };
	...
	public static final String KEY_REPORT = "org.freeland.wildscanlaos.ReportWizard.Report";
	public static final String KEY_STATE = "org.freeland.wildscanlaos.ReportWizard.State";
	public static final String KEY_SPECIES_ID= "org.freeland.wildscanlaos.ReportWizard.SpeciesId";
	...
	public void onCreate(final Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            */
			...
			createReport(savedInstanceState);
		}
	}

	protected LocationRequest createLocationRequest() {
		LocationRequest lr = new LocationRequest();
		lr.setInterval(120000);
    ...
    private void createReport(Bundle savedInstanceState) {
	    ...
	    if (intent.resolveActivity(getPackageManager()) != null) {
	        ...
	        if (photoFile != null) {
	        	...
	        	if (dir.isDirectory() || dir.mkdirs()) {
					...
					*/
	        		String provider = this.getApplicationContext().getPackageName() + ".fileprovider";
...
//				mCurrentPhotoPath = getExternalCacheDir() + File.separator + TMP_IMAGE_FILE;
	...
	private void updateAddress(boolean isStart, TextView v, boolean full, double lat, double lon) {		
	    ...
	    if (Geocoder.isPresent()) {
	    	if (mStartLocation!=null) {
				LatLng loc = new LatLng(mStartLocation.getLatitude(), mStartLocation.getLongitude());
				new GetAddressTask(this, v, full).execute(loc);
			}
	    	else {
				//LatLng loc = new LatLng(0.00, 0.00);
				//new GetAddressTask(this, v, full).execute(loc);
				//address = "The location service is currently not available";
			}
	    }
	    else {
			//LatLng loc = new LatLng(0.00, 0.00);
			//new GetAddressTask(this, v, full).execute(loc);
			//address = "The geocoder service is not present";
		}
	}
...
//					new Geocoder(mContext, Locale.getDefault());
			...
			try {
				...
				addresses = geocoder.getFromLocation(mStartLocation.getLatitude(), mStartLocation.getLongitude(), 1);
