...
public class SpeciesLibActivity extends Activity implements OnItemClickListener {
    // bundle keys
    static final String KEY_TYPE_FILTER = "org.freeland.wildscanlaos.SpeciesLib.TypeFilter";
    static final String KEY_PROD_ANI_FILTER = "org.freeland.wildscanlaos.SpeciesLib.ProdAniFilter";
    static final String KEY_COVER_FILTER = "org.freeland.wildscanlaos.SpeciesLib.CoveringFilter";
    static final String KEY_NUMLEGS_FILTER = "org.freeland.wildscanlaos.SpeciesLib.NumLegsFilter";
    static final String KEY_COLOR_FILTER = "org.freeland.wildscanlaos.SpeciesLib.ColorFilter";
    static final String KEY_SIZE_FILTER = "org.freeland.wildscanlaos.SpeciesLib.SizeFilter";
    static final String KEY_SPEC_FILTER = "org.freeland.wildscanlaos.SpeciesLib.SpecialFeaturesFilter";
    static final String KEY_PURPOSE_FILTER = "org.freeland.wildscanlaos.SpeciesLib.PurposeFilter";
    static final String KEY_P_PURPOSE_FILTER = "org.freeland.wildscanlaos.SpeciesLib.P_PurposeFilter";
    static final String KEY_FORM_FILTER = "org.freeland.wildscanlaos.SpeciesLib.FormFilter";
    static final String KEY_MATERIAL_FILTER = "org.freeland.wildscanlaos.SpeciesLib.MaterialFilter";
...
// .AUTHORITY + "/" + WildscanDataManager.SpeciesImages.TABLE_NAME);
    static final String KEY_PART_FILTER = "org.freeland.wildscanlaos.SpeciesLib.PartFilter";
    static final String KEY_SHOW_FAVS = "org.freeland.wildscanlaos.SpeciesLib.ShowFavorites";
    static final String KEY_ISLIST = "org.freeland.wildscanlaos.SpeciesLib.IsList";
    static final String KEY_LIST_POSITION = "org.freeland.wildscanlaos.SpeciesLib.ListPosition";
    static final String KEY_LIST_OFFSET = "org.freeland.wildscanlaos.SpeciesLib.ListOffset";
    static final String KEY_NEED_RESULT = "org.freeland.wildscanlaos.SpeciesLib.NeedResult";
    static final String KEY_RESULT_SPECIES_ID = "org.freeland.wildscanlaos.SpeciesLib.SpeciesId";
    static final String KEY_RESULT_SPECIES_NAME = "org.freeland.wildscanlaos.SpeciesLib.SpeciesName";
...
//		     showSpecies();
    ...
    private String mFormFilter = null;
    private String mP_purposeFilter = null;
...
//		bar.setSubtitle("Species");
        ...
        if (b != null) {
            ...
            mFormFilter = b.getString(KEY_FORM_FILTER, null);
            mP_purposeFilter = b.getString(KEY_P_PURPOSE_FILTER, null);
    ...
    private void showSpecies() {
        ...
        //}
            ...
            if (mSpecialFeaturesFilter != null) {
                String [] items = mSpecialFeaturesFilter.split("/");
                for(int i = 0; i < items.length; i++) {
                    String mString = items[i];
                    mCurrFilterSelection = addFilter(mCurrFilterSelection, field, mString);
                }
            }
            ...
            if (mFormFilter != null) {
                mCurrFilterSelection = addFilter(mCurrFilterSelection, field, mFormFilter);
            }
            if (mP_purposeFilter != null) {
                mCurrFilterSelection = addFilter(mCurrFilterSelection, field, mP_purposeFilter);
            }
            if (mCurrFilterSelection != null) {
                mIsFromWizard = true;
            }
        ...
        String orderBy = Species._S_COMMON_NAME;
        //String orderBy = "cast(" + Species._ID +  " as text) DESC";
//        String orderBy = Species._S_TYPE + " , " + Species._S_COMMON_NAME + " ASC";
        ...
        */
        ...
        //Log.e("Query : ", String.valueOf(sBaseQueryUri));
        ...
        while(mCursor.moveToNext()) {
            int cname_index, id_index ;

            cname_index = mCursor.getColumnIndexOrThrow(Species._S_COMMON_NAME);
            id_index = mCursor.getColumnIndexOrThrow(Species._ID);
            String commonName = mCursor.getString(cname_index);
            String sid = mCursor.getString(id_index);

            Log.e("Species : ", commonName);
        }
