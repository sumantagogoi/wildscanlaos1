...
import org.freeland.wildscanlaos.communication.ServiceGenerator;
import org.freeland.wildscanlaos.data.WildscanDataManager;
import org.freeland.wildscanlaos.data.WildscanDataManager.SyncProgressListener;
import org.freeland.wildscanlaos.data.WildscanDownloaderService;
import org.freeland.wildscanlaos.models.RegionStats;
...
import org.freeland.wildscanlaos.util.Util.InvalidCrcException;
...
public class WildscanLaunchActivity extends Activity implements IDownloaderClient, SyncProgressListener {
    ...
    private void startMainActivity() {
        ...
        if (Util.isNetworkAvailable(this))
            mDataManager.requestSync(this, !isFirstTime, isFirstTime, null);
        else {
        ...
        regionStatsCall.enqueue(new Callback<StatsResponse>() {
            ...
            public void onResponse(Response<StatsResponse> response, Retrofit retrofit) {
                if (response.isSuccess()) {
                    RegionStats global = response.body().getData().get(0);
                    RegionStats asia = response.body().getData().get(1);
                    /*
                    AppPreferences.setRegionStats(WildscanLaunchActivity.this,
                            global.getTotal_contacts(), global.getTotal_species(),
                            asia.getTotal_contacts(), asia.getTotal_species());
                    */
                }
            }
